...
class ContactCoordonneeType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('email', TextType::class, array('label' => 'Email (si plusieurs adresses mails séparer par un ";"):','required' => false, 'empty_data'  => null))
                ->add('emailFacturation', TextType::class,array('label'=>'Email de Facturation (si différent) : ','required'=>false,'empty_data'=>null))
